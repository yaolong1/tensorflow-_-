...
def detect_objects(image_np, sess, detection_graph):
    ...
    return dict(rect_points=rect_points, class_names=class_names, class_colors=class_colors),class_names
...
def worker(input_q, output_q):
    ...
    while True:
        ...
        print(detect_objects(frame_rgb, sess, detection_graph))
