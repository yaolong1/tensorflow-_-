    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          i = i + 1;
          # time.sleep(2000)
          # if i%50000000000*100:
          #  print("睡眠了50000000000次")
          #  display_list = []

          display_str2 = display_str[0:-5]
          # print(display_str2)
          display_list.append(display_str2)
          print(set(display_list))

          file_handle = open('1.txt', mode='w')
          file_handle.write(str(set(display_list)))
