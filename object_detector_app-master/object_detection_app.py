...
if __name__ == '__main__':
    ...
    # webcamera
    cam_url = 'rtsp://admin:admin123@172.23.205.197:554/stream/realtime?channel=1&streamtype=0'
    ...
    while True:  # fps._numFrames < 120
        if time.time() - t_start > 0.20:  # 因为识别速度和视频帧率相差过大，为了使输出图像与摄像头输入保持同步，所以每两秒输出一次识别结果。该参数可以根据计算性能加以调整
            t_start = time.time()
